...
#0 config
model_dir=/home/zhaoyang/tf_repos/model/
data_dir=/home/zhaoyang/tf_repos/data/criteo/
...
python3 ./Model_pipeline/DeepFM.py --learning_rate=0.001 --optimizer=Adam --num_epochs=101 --embedding_size=32 --batch_size=256 --field_size=39 --feature_size=117581 --deep_layers=256,128 --dropout=0.8,0.8 --l2_reg=0.0001 --log_steps=1000 --num_threads=8 --model_dir=${model_dir}/DeepFM/ --data_dir=${data_dir}
